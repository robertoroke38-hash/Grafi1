...
def draw_cube():
    ...
    glLoadIdentity()
    glTranslatef(math.sin(angle), 0.1, -4)  # Alejar el cubo para que sea visible
    glRotatef(180, 1, 0, 1)   # Rotar el cubo en todos los ejes
    ...
    angle += 0.0001 # Incrementar el ángulo para rotación
